...
class Video():
    ...
    def __init__(self, port=5600):
        ...
        self.video_source = 'udpsrc port={} ! application/x-rtp, media=video, payload=96, width=1280, height=720'.format(self.port)
        ...
        self.video_codec = '! application/x-rtp, payload=96 ! rtph264depay ! h264parse ! avdec_h264'
        self.video_decode = '! videoconvert ! video/x-raw, format=(string)BGR ! videoconvert'
    ...
    def start_gst(self, config=None):
        ...
        if not config:
            config =  [
                '{} ! capsfilter caps="application/x-rtp, media=video, payload=96"'.format(self.video_source),
                self.video_codec,
                self.video_decode,
                self.video_sink_conf
            ]
    ...
    while True:
        ...
        if video.frame_available():
            ...
            if detected_bottle:
                ...
                control_motors(master, 1500, 1500, 1500, 1600, 1500, 1500,1500)
            else:
